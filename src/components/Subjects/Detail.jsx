  ...
  return (
    <div className="fixed inset-0 flex items-center justify-center bg-black bg-opacity-30">
      <div className="bg-white text-center w-2/3 h-2/3 border-blue">
        <h2 className="text-xl font-bold bg-blue text-white p-2">
          ESTADO DE LA ASIGNATURA
        </h2>
        <p className="text-md text-blue font-bold uppercase m-10">
          {subject?.name}
        </p>
        <div className="h-2/4 flex justify-between mr-12 ml-12 gap-7">
          <div className="w-1/5 flex flex-col items-center rounded-2xl bg-blue text-white p-3">
            <img
              ...
              alt="Logo"
              className="w-1/2 h-4/2 mb-2 mt-8 rounded-full"
            />
            <label className="text-xs m-3 font-bold">ESTUDIANTES</label>
            <label>24 estudiantes registrados</label>
            <button className="bg-blood text-white text-sm mt-5 px-4 py-2 w-2/3 h-auto rounded-full">
              <Link to={`/asignaturas/${subject?.id}/estudiantes`}>
              AGREGAR
              </Link>
            </button>
          </div>
          <div className=" w-1/5 flex flex-col items-center rounded-2xl bg-blue text-white p-3">
            ...
            <button className="bg-blood text-white text-sm  px-4 py-2 w-2/3 h-auto rounded-full">
              <Link to={`/asignaturas/${subject?.id}/profesores`}>
              AGREGAR
              </Link>
            </button>
          </div>
          ...
          <div className="w-1/5 flex flex-col items-center rounded-2xl bg-blue text-white p-3">
            ...
            <button className="bg-blood text-white text-sm mt-5 px-4 py-2 w-2/3 h-auto rounded-full">
              <Link to={`/asignaturas/${subject?.id}/turnos`}>AGREGAR</Link>
            </button>
          </div>
          <div className="w-1/5 flex flex-col items-center rounded-2xl bg-blue text-white p-3">
            <img
            ...
            <button className="bg-blood text-white text-sm mt-5 px-4 py-2 w-2/3 h-auto rounded-full">
              <Link to={`/asignaturas/${subject?.id}/documentos`}>
              AGREGAR
              </Link>
            </button>
          </div>
